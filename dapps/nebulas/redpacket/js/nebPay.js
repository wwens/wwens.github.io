...
;(function (globalObj) {
    ...
    */
    ...
    function constructorFactory(config) {
         ...
         * of this BigNumber is 卤Infinity or NaN.
         */
         ...
         *
         * If k is out of range and ERRORS is false, the result will be 卤0 if k < 0, or 卤Infinity
         * otherwise.
         *
        ...
        P.toPower = P.pow = function ( n, m ) {
            ...
            // Pass 卤Infinity to Math.pow if exponent is out of range.
